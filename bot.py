...
@bot.command(pass_context=True)
async def help(ctx):
    embed = discord.Embed(title='Help.', description="**Invite Link:** https://discordapp.com/api/oauth2/authorize?client_id=512328151758798849&permissions=8&scope=bot", color = 0xf6d025)
...
async def commandhelp(ctx):
    embed = discord.Embed(title='Help Command', description="**Invite Link:** https://discordapp.com/api/oauth2/authorize?client_id=512328151758798849&permissions=8&scope=bot", color = 0xf6d025)
...
bot.run('NTEyMzI4MTUxNzU4Nzk4ODQ5.Ds426Q.D7hUXxTzv6qVazytaZJLLsPIeG8')
